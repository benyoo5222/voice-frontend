...
function Footer({ userInfo, updateModalState }) {
    console.log('Use location', useLocation());
    const location = useLocation();
    const history = useHistory();

    const openModal = () => {
        updateModalState((state, props) => {
        ...
        <div className="footer-container">
            ...
            <div className="icons-container">
                ...
                <div className="compose-button-container">
                    <div className="compose-button" onClick={openModal}>
                    ...
                    <div className="large-compose-button" onClick={openModal}>
